...
from kfp.legacy.components import modelbase
...
class InputSpec(modelbase.ModelBase):
...
class OutputSpec(modelbase.ModelBase):
...
class InputValuePlaceholder(modelbase.ModelBase):  #Non-standard attr names
...
class InputPathPlaceholder(modelbase.ModelBase):  #Non-standard attr names
    """Represents the command-line argument placeholder that will be replaced
...
class OutputPathPlaceholder(modelbase.ModelBase):  #Non-standard attr names
    """Represents the command-line argument placeholder that will be replaced
...
class InputUriPlaceholder(modelbase.ModelBase):  # Non-standard attr names
...
class OutputUriPlaceholder(modelbase.ModelBase):  # Non-standard attr names
...
class InputMetadataPlaceholder(modelbase.ModelBase):  # Non-standard attr names
...
class InputOutputPortNamePlaceholder(modelbase.ModelBase):  # Non-standard attr names
...
class OutputMetadataPlaceholder(modelbase.ModelBase):  # Non-standard attr names
...
class ExecutorInputPlaceholder(modelbase.ModelBase):  # Non-standard attr names
...
class ConcatPlaceholder(modelbase.ModelBase):  #Non-standard attr names
    """Represents the command-line argument placeholder that will be replaced
...
class IsPresentPlaceholder(modelbase.ModelBase):  #Non-standard attr names
    """Represents the command-line argument placeholder that will be replaced
...
class IfPlaceholderStructure(modelbase.ModelBase):  #Non-standard attr names
...
class IfPlaceholder(modelbase.ModelBase):  #Non-standard attr names
    """Represents the command-line argument placeholder that will be replaced
...
class ContainerSpec(modelbase.ModelBase):
...
class ContainerImplementation(modelbase.ModelBase):
...
class MetadataSpec(modelbase.ModelBase):
...
class ComponentSpec(modelbase.ModelBase):
...
class ComponentReference(modelbase.ModelBase):
    """Component reference.
...
class GraphInputReference(modelbase.ModelBase):
...
class GraphInputArgument(modelbase.ModelBase):
...
class TaskOutputReference(modelbase.ModelBase):
...
class TaskOutputArgument(modelbase.ModelBase
...
class TwoOperands(modelbase.ModelBase):
...
class BinaryPredicate(modelbase.ModelBase):  #abstract base type
...
class TwoBooleanOperands(modelbase.ModelBase):
...
class NotPredicate(modelbase.ModelBase):
...
class AndPredicate(modelbase.ModelBase):
...
class OrPredicate(modelbase.ModelBase):
...
class RetryStrategySpec(modelbase.ModelBase):
    _serialized_names = {
...
class CachingStrategySpec(modelbase.ModelBase):
    _serialized_names = {
...
class ExecutionOptionsSpec(modelbase.ModelBase):
    _serialized_names = {
...
class TaskSpec(modelbase.ModelBase):
    """Task specification.
...
class GraphSpec(modelbase.ModelBase):
...
class GraphImplementation(modelbase.ModelBase):
...
class PipelineRunSpec(modelbase.ModelBase):
